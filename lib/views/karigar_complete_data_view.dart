...
class KarigarCompleteView extends StatelessWidget {
  UserData userData = Get.put(UserData());
  ScrollController scrollController = ScrollController();
  @override
  Widget build(BuildContext context) {
    return GetBuilder<UserData>(builder: ((controller) {
      return userData.karigardatalist.isNotEmpty
          ? ListView.builder(
              scrollDirection: Axis.vertical,
              controller: scrollController,
              physics: const BouncingScrollPhysics(parent: AlwaysScrollableScrollPhysics()),
              itemCount: userData.karigardatalist.length,
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Text(
                                          userData.karigardatalist[index].c0.toString(),
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          datechanger(userData.karigardatalist[index].c3.toString()),
